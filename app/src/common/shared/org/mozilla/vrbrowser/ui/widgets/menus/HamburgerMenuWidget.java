...
public class HamburgerMenuWidget extends UIWidget implements
    ...
    public static final int SWITCH_SEE_THROUGH_ITEM_ID = 0;
    ...
    private void updateItems() {
        ...
        mItems.add(new HamburgerMenuAdapter.MenuItem.Builder(
                ...
                .withTitle(getContext().getString(R.string.hamburger_history))
                .withIcon(R.drawable.ic_icon_history)
                .build());
        ...
        mItems.add(new HamburgerMenuAdapter.MenuItem.Builder(
                ...
                (menuItem) -> {
                    if (mDelegate != null) {
                        mDelegate.onDownloads();
                    }
                    return null;
                })
                .withTitle(getContext().getString(R.string.hamburger_downloads))
                .withIcon(R.drawable.ic_icon_downloads)
                .build());
        ...
        mItems.add(new HamburgerMenuAdapter.MenuItem.Builder(
                ...
                (menuItem) -> {
                    if (mDelegate != null) {
                        mDelegate.onBookmarks();
                    }
                    return null;
                })
                .withTitle(getContext().getString(R.string.hamburger_bookmarks))
                .withIcon(R.drawable.ic_icon_bookmark)
                .build());
        ...
        HamburgerMenuAdapter.MenuItem seethrough_item = new HamburgerMenuAdapter.MenuItem.Builder(
                HamburgerMenuAdapter.MenuItem.TYPE_DEFAULT,
                (menuItem) -> {
                    if (mDelegate != null) {
                        mDelegate.onSwitchSeeThrough();
                    }
                    return null;
                })
                .withId(SWITCH_SEE_THROUGH_ITEM_ID)
                .withTitle(getContext().getString(R.string.hamburger_menu_switch_to_seethrough))
                .build();
        switch (mCurrentUAMode) {
            case GeckoSessionSettings.USER_AGENT_MODE_DESKTOP: {
                seethrough_item.setIcon(R.drawable.ic_icon_dialog_camera);
            }
            break;
